from models.models import LawProject, DeputyProject
...
class ActivityCollector:
    ...
    def get_deputy_activity(self, from_date=None, to_date=None):
        logging.info(f"getting activity for deputy {self.deputy_id}")
        ...
        self.projects = list_of_projects
    ...
    def get_projects_from_page(self):
        ...
        for project in projects_in_page:
            ...
            law_project = {
                "id": project_text_lines[0],
                "name": project_text_lines[3],
                "status": project_text_lines[6],
                "creation_date": project_date,
            }
    ...
    def save_activity(self):
        for project in self.projects:
            law_project = LawProject(**project)
            deputy_project = DeputyProject(
